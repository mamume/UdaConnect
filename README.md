...
* [gRPC](https://grpc.io/) - a cross-platform open source high performance Remote Procedure Call framework.
* [Docker](https://www.docker.com/) - a set of platform as a service products that use OS-level virtualization to deliver software in packages called containers.
* [Apache Kafka](https://kafka.apache.org/) - a distributed event store and stream-processing platform.
...
8. `kubectl apply -f deployment/namespace.yaml` - Set up the Kafka namespace
9. `kubectl apply -f deployment/zookeeper.yaml` - Set up zookeeper for kafka
10. `kubectl apply -f deployment/kafka.yaml` - Set up Kafka message broker
...
`kubectl get pods` and `kubectl get services` - should return `udaconnect-app`, `udaconnect-api`, `postgres`, `udaconnect-connections-api`, `udaconnect-persons-api`, `zookeeper-service`, `kafka-service`, `udaconnect-location-producer`, and `udaconnect-location-consumer`

#### Deployments

![Deployments](docs/deployments_screenshot.png)
